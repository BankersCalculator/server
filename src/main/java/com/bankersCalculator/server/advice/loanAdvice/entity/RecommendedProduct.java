...
public class RecommendedProduct {
    ...
    public static RecommendedProduct create(User user, LoanAdviceResult loanAdviceResult, int rank, String loanProductName, String loanProductCode, BigDecimal possibleLoanLimit, BigDecimal expectedLoanRate, String notEligibleReasons) {
