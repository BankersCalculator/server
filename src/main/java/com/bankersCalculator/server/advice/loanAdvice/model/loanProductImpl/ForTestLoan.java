...
@Component
public class ForTestLoan implements LoanProduct {

    private final RateProviderService rateProviderService;

    private static final BigDecimal INCOME_LIMIT = new BigDecimal("500");
    private static final BigDecimal LOAN_LIMIT = new BigDecimal("300000");
